...
This document is the supplementary material for the manuscript "The effect of weather on resource ordering patterns during large wildland fires".  We provide more detail on the data used in the analysis.  We also provide the complete regression tables and full set of figures based on our analyses.
